...
CREATE TABLE IF NOT EXISTS `meetingroom_croom` (
  ...
  PRIMARY KEY  (`cr_id`),
  KEY `name` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=tis620 PACK_KEYS=0 AUTO_INCREMENT=18 ;

--
-- dump ตาราง `meetingroom_croom`
--

INSERT INTO `meetingroom_croom` (`cr_id`, `name`, `net`, `parent`, `pro`, `board`, `comp`, `type`, `tt`, `dater`, `picType`, `picData`) VALUES
(1, 'ห้องทดสอบ', 15, 7, 'มี', 'มี', 'มี', '', 0, '', '', 'blank.jpg'),
(2, 'ห้องสโมสรนักศึกษา', 34, 7, '-', '-', '-', '', 0, '', '', 'blank.jpg'),
(3, 'ห้องปฏิบัติการคอมพิวเตอร์', 80, 0, 'มี', 'มี', 'มี', '', 0, '', '', 'blank.jpg'),
(4, 'ห้องโสตฯ', 45, 7, 'มี', '-', '-', '', 0, '', '', 'blank.jpg'),
(7, 'ห้องประชุม', 0, 0, '0', '', '', '', 0, '', '', 'blank.jpg');
...
INSERT INTO `organization` (`DeID`, `Code`, `Fname`, `Sname`, `Chair`, `Type`, `Posit`) VALUES
(1, 'PH', 'คณะสาธารณสุขศาสตร์', 'คณะสาสุข', '', '0', '1'),
...
(16, 'PHSOFA', 'หน่วยการเงินและบัญชี', 'การเงิน', 'หัวหน้าหน่วย', '2', '1'),
(17, 'PHSOPS', 'หน่วยพัสดุ', 'พัสดุ', 'หัวหน้าหน่วย', '2', '1'),
(18, 'PHSOCU', 'หน่วยสารบรรณ', 'สารบรรณ', 'หัวหน้าหน่วย', '2', '1'),
(19, 'PHSOMU', 'หน่วยซ่อมบำรุง', 'ซ่อมบำรุง', 'หัวหน้าหน่วย', '2', '1'),
(20, 'PHSOPP', 'งานนโยบายและแผน', 'งานแผน', 'หัวหน้างาน', '2', '1'),
(21, 'PHSOAA', 'งานบริการการศึกษา', 'การศึกษา', 'หัวหน้างาน', '2', '1'),
(22, 'PHSOPU', 'หน่วยการเจ้าหน้าที่', 'การเจ้าหน้าที่', 'หัวหน้าหน่วย', '2', '1'),
(23, 'PHSOTU', 'หน่วยยานยนต์', 'ยานยนต์', 'หัวหน้าหน่วย', '2', '1'),
(24, 'PHSOLU', 'หน่วยประชาสัมพันธ์', 'ประชาสัมพันธ์', 'หัวหน้าหน่วย', '2', '1'),
(25, 'PHSORU', 'หน่วยบริหารและพัฒนางานวิจัย', 'หน่วยวิจัย', 'หัวหน้าหน่วย', '2', '1'),
(26, 'PHSOIU', 'หน่วยวิเทศสัมพันธ์', 'หน่วยวิเทศ', 'หัวหน้าหน่วย', '2', '1'),
(27, 'PHSOAV', 'ศูนย์ผลิตและพัฒนาสื่อสาธารณสุข', 'ศูนย์ผลิต', 'หัวหน้าศูนย์', '2', '1'),
(28, 'PHSOMP', 'หน่วยประสานงานหลักสูตร ส.ม.', 'ส.ม.', 'ประธานหลักสูตร', '2', '1'),
(29, 'PHSOOV', 'สำนักงานเทคโนโลยีสาธารณสุข', 'สนง.เทคโน', 'หัวหน้าสำนักงาน', '2', '1'),
(30, 'PHSOCL', 'สำนักงานปฏิบัติการกลาง', 'LAB กลาง', 'หัวหน้าสำนักงาน', '2', '1'),
(31, 'PHSOSG', 'ฝ่ายเลขานุการ', 'ฝ่ายเลขา', '', '2', '1'),
(32, 'PHSOIT', 'หน่วยเทคโนโลยีสารสนเทศ', 'ไอที', 'หัวหน้าหน่วย', '2', '1'),
(33, 'PHSOBA', 'หน่วยอาคารสถานที่', 'สถานที่', 'หัวหน้าหน่วย', '2', '1'),
(34, 'PHSOSM', 'หน่วยบริการการประชุม', 'การประชุม', 'หัวหน้าหน่วย', '2', '1'),
(35, 'PHSODP', 'หน่วยประสานงานหลักสูตร ส.ด.', 'ส.ด.', 'ประธานหลักสูตร', '2', '1'),
(36, '', 'ฝ่ายกิจการนักศึกษา', 'กิจการ น.ศ.', 'หัวหน้าฝ่าย', '2', '1'),
(37, '', 'ศูนย์ส่งเสริมสุขภาพ', 'ศูนย์สุขภาพ', '', '2', '1'),
(38, '', 'อาคารเอนกประสงค์', 'อาคาร 7', '', '2', '1'),
(39, '', 'หน่วยประกันคุณภาพการศึกษา', 'ประกันคุณภาพ', '', '2', '1'),
(40, '', 'โครงการเร่งรัดผลิตบัณฑิตทันตแพทย์', 'ผลิตทันต', '', '3', '1'),
(41, '', 'ชมรมดนตรีไทย', 'ดนตรีไทย', 'ประธานชมรม', '3', '1'),
(42, 'PHSOFP', 'งานคลังและพัสดุ', 'งานคลัง', 'หัวหน้างาน', '2', '1'),
(43, 'PHSOAG', 'งานบริหารและธุรการ', 'งานบริหาร', 'หัวหน้างาน', '2', '1'),
...
INSERT INTO `user` (`NO`, `USR_CODE`, `USR_PAS`, `USR_NAME`, `USR_SURNAME`, `DEPARTMENT_NO`, `SUBDEPARTMENT_NO`, `USR_LASTUPDATE`, `ONLINE_COUNT`, `ONLINE_ADD`, `ONLINE_UPDATE`, `ONLINE_DELETE`, `EMAIL`, `LOGIN`, `BLOCK`, `photo`, `G_ID`) VALUES
