...
<nav class="navbar navbar-static-top navbar-inverse">
      <div class="container">
        ...
        <a class="navbar-brand" href="allrooms-external.php"><?php print $siteicon.' '.$sitename_01;?></a>
        </div>
        
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse font-16" id="bs-example-navbar-collapse-1">
        	<ul class="nav navbar-nav navbar-right">
            	<li><a href="allrooms-external.php"><i class="fa fa-angle-double-left"></i> Back</a></li>
            </ul>
        </div>
