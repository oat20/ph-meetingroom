...
<div class="container-fluid">
    ...
    <div class="panel panel-default">
    	<div class="panel-heading">
        	<h3 class="panel-title">รายการจองห้องวันที่ <?php print dateThai($tm);?></h3>
        </div>
    ...
    <p><a href="<?php echo $livesite;?>directmail/event-pdf.php?tm=<?php echo $tm;?>" target="_blank"><i class="fa fa-file-pdf-o"></i> Download รายการจองห้อง</a></p>
