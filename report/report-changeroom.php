    	...
    	<div class="col-sm-12">
        	...
        	<div class="panel panel-primary">
            	<div class="panel-heading">
                	<h3 class="panel-title">ประวัติการเปลี่ยนห้อง</h3>
                </div>
                <div class="panel-body">
					...
					if(isset($_POST['startDate']) and isset($_POST['endDate'])){
						...
						meetingroom_userq_log,
						meetingroom_croom,
						organization
						where meetingroom_userq.Dater between '$_POST[startDate]' and '$_POST[endDate]'
						and meetingroom_userq.uq_id = meetingroom_userq_log.uq_id
						and meetingroom_userq_log.cr_id = meetingroom_croom.cr_id
						and meetingroom_userq.DeID = organization.DeID
						order by meetingroom_userq.created asc,
						meetingroom_userq.Dater asc, 
						meetingroom_userq.time_in asc,
						meetingroom_userq_log.log_datestamp desc";
						...
						echo '<div class="clearfix">
									...
									<div class="pull-right">'.number_format($total).' รายการ <a href="3_exportdatacancel_xls.php?startDate='.$_POST['startDate'].'&endDate='.$_POST['endDate'].'" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-file-excel-o"></i> Export to Excel</a></div>
							</div>
							<hr>';
										...
										<table class="table table-hover">
											...
											while($ob2=mysql_fetch_assoc($rs2)){
												echo '<tr>
															...
															<td>'.dateThai2($ob2['log_datestamp']).'</td>
													</tr>';
											}
										echo '</tbody>
										</table>
