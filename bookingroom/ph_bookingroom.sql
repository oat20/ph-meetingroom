...
) ENGINE=InnoDB  DEFAULT CHARSET=tis620 AUTO_INCREMENT=14 ;

-- 
-- dump ตาราง `menu`
-- 

INSERT INTO `menu` VALUES (11, 'othermenu', 'รายการจองทั้งหมด', 'joomla-home', 'http://www.joomla.org', 'url', -2, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', 0, 0, 0, 3, 'menu_image=-1\n\n', 0, 0, 0);
INSERT INTO `menu` VALUES (12, 'othermenu', 'ข้อมูลส่วนตัว', 'joomla-forums', 'http://forum.joomla.org', 'url', -2, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', 0, 0, 0, 3, 'menu_image=-1\n\n', 0, 0, 0);
INSERT INTO `menu` VALUES (13, 'othermenu', 'ผู้ใช้ระบบ', 'joomla-documentation', 'http://docs.joomla.org', 'url', -2, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', 0, 0, 0, 3, 'menu_image=-1\n\n', 0, 0, 0);
...
CREATE TABLE `room_booking` (
  ...
  `useradd` varchar(255) default NULL COMMENT 'ผู้จอง',
  `location` text,
...
) ENGINE=InnoDB  DEFAULT CHARSET=tis620 AUTO_INCREMENT=25 ;
...
INSERT INTO `room_booking` VALUES (3, 'CMS Joomla', 15, 'asdf', 'CMS Joomla', 'sadf', '08.30', '16.30', '2009-06-01', '2009-06-01', 'webmaster', NULL, 32, '<br>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25);
...
INSERT INTO `room_booking` VALUES (24, '', 16, '', '', '', '08.00', '17.00', '2009-08-13', '2009-08-14', 'อ.วิทยา', NULL, 15, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 50);
...
CREATE TABLE `room_category` (
  ...
  PRIMARY KEY  (`cid`)
) ENGINE=InnoDB  DEFAULT CHARSET=tis620 AUTO_INCREMENT=18 ;

-- 
-- dump ตาราง `room_category`
-- 

INSERT INTO `room_category` VALUES (15, 'ห้องเรียน 7402', NULL, '30', 0, '2009-06-26 17:01:27', NULL, 1, '#FFCC00');
INSERT INTO `room_category` VALUES (16, 'ห้องเรียน 7403', NULL, '20', 0, '2009-06-26 16:58:50', NULL, 1, '#339933');
INSERT INTO `room_category` VALUES (17, 'ห้องเรียน 7404', NULL, '20', 0, '2009-06-22 16:17:38', NULL, 1, '#FF66CC');
...
-- 
-- โครงสร้างตาราง `room_term`
-- 

CREATE TABLE `room_term` (
...
CREATE TABLE `tb_department` (
  ...
  PRIMARY KEY  (`dp_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=tis620 COMMENT='ส่วนราชการ (ภาควิชา/หน' AUTO_INCREMENT=43 ;

-- 
-- dump ตาราง `tb_department`
-- 

INSERT INTO `tb_department` VALUES (1, 0, 'คณะสาธารณสุขศาสตร์', '', '1', 0);
INSERT INTO `tb_department` VALUES (2, 1, 'ภาควิชาการพยาบาลสาธารณสุข', '3402', '1', 1);
INSERT INTO `tb_department` VALUES (3, 2, 'ภาควิชาจุลชีววิทยา', '6514', '1', 1);
INSERT INTO `tb_department` VALUES (4, 3, 'ภาควิชาชีวสถิติ', '3203', '1', 1);
INSERT INTO `tb_department` VALUES (5, 4, 'ภาควิชาบริหารงานสาธารณสุข', '2304', '1', 1);
INSERT INTO `tb_department` VALUES (6, 5, 'ภาควิชาปรสิตวิทยา', '1208', '1', 1);
INSERT INTO `tb_department` VALUES (7, 6, 'ภาควิชาโภชนวิทยา', '1304', '1', 1);
INSERT INTO `tb_department` VALUES (8, 7, 'ภาควิชาระบาดวิทยา', '3301', '1', 1);
INSERT INTO `tb_department` VALUES (9, 8, 'ภาควิชาวิทยาศาสตร์อนามัยสิ่งแวดล้อม', '2403', '1', 1);
INSERT INTO `tb_department` VALUES (10, 9, 'ภาควิชาวิศวกรรมสุขาภิบาล', '2201', '1', 1);
INSERT INTO `tb_department` VALUES (11, 10, 'ภาควิชาสุขศึกษาและพฤติกรรมศาสตร์', '3604', '1', 1);
INSERT INTO `tb_department` VALUES (12, 11, 'ภาควิชาอนามัยครอบครัว', '1302', '1', 1);
INSERT INTO `tb_department` VALUES (13, 12, 'ภาควิชาอาชีวอนามัยและความปลอดภัย', '2601', '1', 1);
INSERT INTO `tb_department` VALUES (14, 13, 'สถานฝึกอบรมและวิจัยอนามัยชนบท', '', '1', 1);
INSERT INTO `tb_department` VALUES (15, 14, 'สำนักงานคณบดี', '1110', '1', 0);
INSERT INTO `tb_department` VALUES (16, 14, 'หน่วยการเงินและบัญชี', '', '1', 15);
INSERT INTO `tb_department` VALUES (17, 14, 'หน่วยพัสดุ', '5102, 5107', '1', 15);
INSERT INTO `tb_department` VALUES (18, 14, 'หน่วยสารบรรณ', '', '1', 15);
INSERT INTO `tb_department` VALUES (19, 14, 'หน่วยซ่อมบำรุง', '', '1', 15);
INSERT INTO `tb_department` VALUES (20, 22, 'งานนโยบายและแผน', '', '1', 15);
INSERT INTO `tb_department` VALUES (21, 24, 'งานบริการการศึกษา', '', '1', 15);
INSERT INTO `tb_department` VALUES (22, 14, 'หน่วยการเจ้าหน้าที่', '', '1', 15);
INSERT INTO `tb_department` VALUES (23, 14, 'หน่วยยานยนต์', '', '1', 15);
INSERT INTO `tb_department` VALUES (24, 14, 'หน่วยประชาสัมพันธ์', '', '1', 15);
INSERT INTO `tb_department` VALUES (25, 14, 'หน่วยบริหารและพัฒนางานวิจัย', '', '1', 15);
INSERT INTO `tb_department` VALUES (26, 14, 'หน่วยวิเทศสัมพันธ์', '', '1', 15);
INSERT INTO `tb_department` VALUES (27, 14, 'ศูนย์ผลิตและพัฒนาสื่อสาธารณสุข', '', '1', 15);
INSERT INTO `tb_department` VALUES (28, 14, 'หน่วยประสานงานหลักสูตร ส.ม.', '', '1', 15);
INSERT INTO `tb_department` VALUES (29, 14, 'สำนักงานเทคโนโลยีสาธารณสุข', '', '1', 15);
INSERT INTO `tb_department` VALUES (30, 14, 'สำนักงานปฏิบัติการกลาง', '', '1', 15);
INSERT INTO `tb_department` VALUES (31, 14, 'ฝ่ายเลขานุการ', '', '1', 15);
INSERT INTO `tb_department` VALUES (32, 14, 'หน่วยเทคโนโลยีสารสนเทศ', '7305', '1', 15);
INSERT INTO `tb_department` VALUES (33, 14, 'หน่วยอาคารสถานที่', '', '1', 15);
INSERT INTO `tb_department` VALUES (34, 14, 'หน่วยบริการการประชุม', '', '1', 15);
INSERT INTO `tb_department` VALUES (35, 14, 'หน่วยประสานงานหลักสูตร ส.ด.', '', '1', 15);
INSERT INTO `tb_department` VALUES (36, 14, 'ฝ่ายกิจการนักศึกษา', '', '1', 15);
INSERT INTO `tb_department` VALUES (37, 14, 'ศูนย์ส่งเสริมสุขภาพ', '', '1', 15);
INSERT INTO `tb_department` VALUES (38, 23, 'งานคลังและพัสดุ', '', '1', 15);
INSERT INTO `tb_department` VALUES (39, 21, 'งานบริหารและธุรการ', '', '1', 15);
INSERT INTO `tb_department` VALUES (40, 51, 'ชมรมดนตรีไทย', '', '2', 15);
INSERT INTO `tb_department` VALUES (42, 99, 'โครงการเร่งรัดพัฒนาบัณฑิตทันตแพทย์', '', '1', 15);
...
CREATE TABLE `tb_ulog` (
  ...
  PRIMARY KEY  (`ul_id`)
) ENGINE=InnoDB DEFAULT CHARSET=tis620 PACK_KEYS=0 COMMENT='บันทึกการเข้าใช้งานร' AUTO_INCREMENT=1 ;
...
CREATE TABLE `tb_user` (
  ...
  PRIMARY KEY  (`us_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=tis620 COMMENT='ข้อมูลผู้ใช้งานระบบ' AUTO_INCREMENT=6 ;

-- 
-- dump ตาราง `tb_user`
-- 

INSERT INTO `tb_user` VALUES (1, 'admin', 'admin', 'Chakkapan Charupoom', 'phccr@staff2.mahidol.ac.th', 1, '1', '1', NULL, 0);
INSERT INTO `tb_user` VALUES (2, 'PH01', 'aawd', NULL, NULL, 1, '2', '1', NULL, 0);
INSERT INTO `tb_user` VALUES (3, 'PH02', 'aawd', NULL, NULL, 1, '2', '1', NULL, 0);
INSERT INTO `tb_user` VALUES (4, 'PHPN', 'aawd', NULL, NULL, 2, '2', '1', NULL, 0);
INSERT INTO `tb_user` VALUES (5, 'PHMI', 'aawd', NULL, NULL, 3, '2', '1', NULL, 0);
...
CREATE TABLE `teacher` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=tis620 AUTO_INCREMENT=7 ;
...
INSERT INTO `user_group` VALUES (2, 'ผู้ของใช้ห้อง');
...
INSERT INTO `user_permission` VALUES (2, 12);
