...
-->
	...
	<?php
		$sql2="select * from meetingroom_userq,meetingroom_croom, jos_users, organization
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
      <tr bgcolor="#59993f">
        ...
        <th><div align="center" class="style3">วิชา/วัตถุประสงค์</div></th>
        <th>ผู้จอง</th>
        <th>ห้อง</th>
		<!--<th>สถานะ</th> -->
        </tr>
      ...
      <tr bgcolor="#e9e9e9">
		...
		<td><a href="#" onclick="NewWin=window.open('inc/roomview.inc.php?<? echo"ID=$ob[id]"; ?>','NewWin','toolbar=no,status=no,width=800,height=600');" title="รายละเอียด"><?php echo $ob2["title"]; ?></a></td>
  	    ...
  	    <?php print $ob2[Fname]; ?></td>
        <td align="center"><?php print $ob2[name]; ?></td>
