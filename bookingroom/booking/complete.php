...
<table width="100%" border="0" cellspacing="0">
	<tr>
        ...
        <tr bgcolor="#B2DFFF">
          ...
          <th><div align="center">วัน/เวลาจอง</div></th>
          <th>ชื่อผู้จอง</th>
          <th><div align="center">สถานภาพ</div></th>
          <td>ตรวจสอบ</td>
        </tr>
		<?php
		$sql="select meetingroom_userq.Dater, room_time.start, room_time.end, jos_users.name, organization.Fname, meetingroom_userq.detail, meetingroom_userq.optionss, meetingroom_userq.created, book_status.sta, meetingroom_userq.title, meetingroom_croom.color, meetingroom_croom.name as room_name, book_status.img, mid(meetingroom_userq.created,12,5) as time_created, meetingroom_userq.uq_id, meetingroom_userq.confirm_by
	   ...
	   order by meetingroom_userq.created desc";
        ...
        <tr>
			...
			if($ob[confirm_by] == 0){
			?>
            <input name="keyuq_id[]" type="checkbox" value="<?=$ob["uq_id"];?>" />
            <?php
			}
			?>
            </td>
