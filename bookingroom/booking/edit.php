...
if($action == "add"){
	...
	if($room != "" && $startdate != "" && $time_in != "" && $time_out != ""){
	   ...
	   $row=mysql_fetch_array($rs);
        ...
        print"</tr>";
		print"<tr>";
		print'<td colspan=2><button class=buttonsubmit onclick="history.back();">ยืนยัน</button> <button class=buttonsubmit onclick="history.back();">แก้ไข</button> <button class=buttonsubmit onclick="history.back();">ยกเลิก</button></td>';
		print"</tr>";
      print"</table>";
			}else{
